...
<div style="display: flex; margin-bottom: 12px; margin-left: 16px;">
  <div style="background: #F7F7F7; width: 224px; height: 58px; display: flex; border-radius: 24px / 29px; margin-right: 12px; font-size: 18px; font-weight: bold; padding: 16px 25px;">
    <p style="margin: 0; line-height: 18px; padding: 4px 0;">状態：</p>
    <p style="margin: 0; line-height: 18px; padding: 4px 0; width: 120px; text-align: right;">公開</p>
  </div>
  ...
  <div style="background: #F7F7F7; width: 900px; height: 58px; display: flex; border-radius: 24px / 29px;  font-size: 18px; font-weight: bold;">
    ...
    <p style="margin: 16px 25px 0 0; line-height: 18px; padding: 4px 0; width: 142px; text-align: right;">265</p>
    ...
    <p style="margin: 16px 25px 0 0; line-height: 18px; padding: 4px 0; width: 124px; text-align: right;">12</p>
    <div style="margin: 9px 0; width: 1px; height: 40px; background: #CECECE;"></div>
    <p style="margin: 16px 0 16px 25px; line-height: 18px; padding: 4px 0; white-space: nowrap;">非表示商品数：</p>
    <p style="margin: 16px 25px 0 0; line-height: 18px; padding: 4px 0; width: 142px; text-align: right;">8</p>
  </div>
</div>
...
<div style="background: #F7F7F7; width: 300px; height: 58px; display: flex; border-radius: 24px / 29px; margin-bottom: 12px; margin-left: 16px;  font-size: 18px; font-weight: bold; padding: 16px 25px;">
  <p style="margin: 0; line-height: 18px; padding: 4px 0;">クーポン参加数：</p>
  <p style="margin: 0; line-height: 18px; width: 106px; text-align: right; padding: 4px 0;">12</p>
</div>
...
<div style="display: flex; margin-left: 16px;">
  <div style="background: #F7F7F7; width: 512px; height: 72px; display: flex; border-radius: 32px / 35px; margin-right: 12px;  font-size: 18px; font-weight: bold; padding: 23px 25px;">
    ...
    <p style="margin: 0 15px 0 0; font-size: 28px; line-height: 28px; text-align: right; width: 195px;">18</p>
    <p style="margin: 0; line-height: 18px; padding: 5px 0;">件</p>
  </div>
  <div style="background: #F7F7F7; width: 286px; height: 72px; display: flex; border-radius: 32px / 35px; margin-right: 12px;  font-size: 18px; font-weight: bold; padding: 23px 25px;">
    ...
    <p style="color: #EF1A0d; margin: 0 15px 0 0; font-size: 28px; line-height: 28px; width: 113px;  text-align: right;">2</p>
    <p style="margin: 0; line-height: 18px; padding: 5px 0;">件</p>
  </div>
  <div style="background: #F7F7F7; width: 294px; height: 72px; display: flex; border-radius: 32px / 35px; margin-right: 12px;  font-size: 18px; font-weight: bold; padding: 22px;">
    <p style="margin: 0 auto; line-height: 18px; padding: 5px; white-space: nowrap;">未発送件数</p>
    <p style="color: #EF1A0d; margin: 0 15px 0 0; font-size: 28px; line-height: 28px; width: 121px;  text-align: right;">12</p>
    <p style="margin: 0 auto; line-height: 18px; padding: 5px 0;">件</p>
  </div>
</div>

<div style="margin-left: 16px; list-style: none; display: flex; font-size: 13px; height: 19px; margin-top: 40px; margin-bottom: 12px;">
  <p>2022.08.25</p>
  <p style="margin-left: 12px;">12:00:00</p>
  <p style="margin-left: 96px; width: 840px; color: #EF1A0D">未処理の注文が複数あります</p>
  <a href="" style="text-decoration:underline;">受注管理へ</a>
</div>
<div style="margin-left: 16px; list-style: none; display: flex; font-size: 13px; height: 19px; margin-bottom: 12px">
  <p>2022.08.25</p>
  <p style="margin-left: 12px;">12:00:00</p>
  <p style="margin-left: 96px; width: 840px; color: #EF1A0D"">未発送の注文が複数あります</p>
  <a href="" style="text-decoration:underline;">受注管理へ</a>
</div>
<div style="margin-left: 16px; list-style: none; display: flex; font-size: 13px; height: 19px; margin-bottom: 40px;">
  <p>2022.08.25</p>
  <p style="margin-left: 12px;">12:00:00</p>
  <p style="margin-left: 96px; width: 840px; color: #EF1A0D"">商品が注文されました</p>
  <a href="" style="text-decoration:underline;">受注管理へ</a>
</div>

<div style="display: flex">
  <div style="width: 650px; height: 240px; border: 1px solid #CECECE; margin-left: 16px; margin-bottom: 10px; background: #FEFEFE;">
    <div style="background: #F7F7F7; width: 650px; height: 36px; position: relative; right: 1px; bottom: 1px; margin-bottom: 14px;">
      <p style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); text-align: center; font-size: 16px; font-weight: bold;">ショップ基本管理</p>
    </div>
  ...
  <div style="width: 320px; height: 240px; border: 1px solid #CECECE; margin-left: 16px; position: relative; background: #FEFEFE;">
    <div style="background: #F7F7F7; width: 320px; height: 36px; position: relative; right: 1px; bottom: 1px; margin-bottom: 14px;">
      <p style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); text-align: center; font-size: 16px; font-weight: bold;">商品情報</p>
    </div>
    <a href="" style="font-size: 14px; font-weight: bold; color: #333333; margin-left: 18px;">出品商品一覧</a>
    <a href="" style="line-height: 1em; font-weight: bold; color: #333333; background: #FFDF58; width: 200px; height: 36px; padding: 11px; border-radius: 18px / 18px; text-align: center; position: absolute; left: 60px; bottom: 18px">商品登録</a>
  </div>
...
<div style="display: flex">
  <div style="width: 320px; height: 240px; border: 1px solid #CECECE; margin-left: 16px; margin-bottom: 28px; background: #FEFEFE;">
    <div style="background: #F7F7F7; width: 320px; height: 36px; position: relative; right: 1px; bottom: 1px; margin-bottom: 14px;">
  ...
  <div style="width: 650px; height: 240px; border: 1px solid #CECECE; margin-left: 16px; background: #FEFEFE;">
    <div style="background: #F7F7F7; width: 650px; height: 36px; position: relative; right: 1px; bottom: 1px; margin-bottom: 14px;">
      <p style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); text-align: center; font-size: 16px; font-weight: bold;">受注管理</p>
    </div>
