...
<div style="width:20%;float:left;">
    <nav class="sidebar">
        <ul>
            ...
            <li><a href="{{ route('admin.adminUsers') }}" class="selected">管理ユーザー</a></li>
...
<form action="" method="GET">
    <div style="width:80%;float:left;">
        <span class="ECM_CheckboxInput-LabelText" style="margin-top:20px;margin-bottom:50px;font-size:20px;">出店規約</span>
