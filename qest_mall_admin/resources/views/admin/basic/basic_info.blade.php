...
<form action="" method="GET">
    <div style="width:80%;float:left;">
        ...
        <span class="ECM_CheckboxInput-LabelText" style="margin-top:20px;margin-bottom:10px;">登録法人情報</span>

        <div style="min-height:50px;width:75%;margin-left:1%;background-color:#F7F7F7;padding:20px;">
        </div>

        <span class="ECM_CheckboxInput-LabelText" style="margin-top:20px;margin-bottom:10px;">サービス情報</span>
