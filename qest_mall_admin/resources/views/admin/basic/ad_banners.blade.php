...
<div style="width:20%;float:left;">
    <nav class="sidebar">
        <ul>
            ...
            <li><a href="{{ route('admin.ad-banners') }}" class="selected">広告バナー編集</a></li>
        </ul>
    </nav>
</div>
<!-- サイドバー -->
...
<form action="" method="GET">
    <div style="width:80%;float:left;">
        <span class="ECM_CheckboxInput-LabelText" style="margin-top:20px;margin-bottom:50px;font-size:20px;">広告バナー編集</span>
