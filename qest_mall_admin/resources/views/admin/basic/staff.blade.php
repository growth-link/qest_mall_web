...
<div style="width:20%;float:left;">
    <nav class="sidebar">
        <ul>
            ...
            <li><a href="{{ route('admin.staff') }}" class="selected">スタッフマスタ</a></li>
...
<form action="" method="GET">
    <div style="width:80%;float:left;">
        <span class="ECM_CheckboxInput-LabelText" style="margin-top:20px;margin-bottom:50px;font-size:20px;">スタッフマスタ</span>
