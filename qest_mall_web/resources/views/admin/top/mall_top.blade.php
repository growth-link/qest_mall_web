...
<div style="display: flex">
  ...
  <div style="width: 650px; height: 240px; border: 1px solid #CECECE; margin-left: 16px; position: relative; background: #FEFEFE;">
    ...
    <a href="" style="line-height: 1em; font-weight: bold; color: #333333; background: #FFDF58; width: 200px; height: 36px; padding: 11px; border-radius: 18px / 18px; text-align: center; position: absolute; left: 224px; bottom: 18px;">新規ショップ追加</a>
  </div>
